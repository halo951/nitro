import "./_common.mjs";
import { B as a, M as formatCompatibilityDate, P as resolveCompatibilityDatesFromEnv, R as i } from "./_libs/c12+rc9+rou3+nypm+klona+citty.mjs";
import { G as findFile, I as prettyPath$1, J as readGitConfig, K as findNearestFile, N as glob, R as writeFile$2, U as p, V as a$1, Y as readPackageJSON, Z as r, at as dirname$1, ct as join$1, dt as resolve$1, nt as resolveModulePath, ut as relative$1, z as K } from "./_build/common.mjs";
...
var preset_default$15 = [defineNitroPreset({ extends: "aws_lambda" }, { name: "genezio" })];
...
var preset_default$9 = [defineNitroPreset({
	extends: "node-server",
	serveStatic: true
}, { name: "platform-sh" })];
...
function deprecateSWR(nitro) {
	...
	if (hasLegacyOptions && !a$1) nitro.logger.warn("Nitro now uses `isr` option to configure ISR behavior on Vercel. Backwards-compatible support for `static` and `swr` options within the Vercel Build Options API will be removed in the future versions. Set `future.nativeSWR: true` nitro config disable this warning.");
}
