import { A as escapeStringRegexp, C as compileRouterToString, D as findRoute, E as findAllRoutes, I as loadConfig, L as watchConfig, N as resolveCompatibilityDates, O as TSConfckCache, P as resolveCompatibilityDatesFromEnv, T as createRouter, _ as z, g as P, j as klona, k as parse, w as addRoute } from "../_libs/c12+rc9+rou3+nypm+klona+citty.mjs";
import { A as compressPublicAssets, H as d, I as prettyPath, L as resolveNitroPath, M as build, R as writeFile$1, V as a, ct as join, dt as resolve, j as src_default, k as scanUnprefixedPublicAssets, nt as resolveModulePath, p as runParallel, q as findWorkspaceDir, rt as resolveModuleURL, ut as relative } from "../_build/common.mjs";
...
async function installPkg(pkg, root) {
	const { addDevDependency } = await import("../_libs/c12+rc9+rou3+nypm+klona+citty.mjs").then((n) => n.o);
