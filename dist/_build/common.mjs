...
import path$1, { basename as basename$1, dirname as dirname$1, extname as extname$1, isAbsolute as isAbsolute$1, normalize as normalize$1, posix, relative as relative$1, resolve as resolve$1, sep as sep$1, win32 as win32$1 } from "path";
...
var e$2 = Object.create, t$6 = Object.defineProperty, n$7 = Object.getOwnPropertyDescriptor, r$6 = Object.getOwnPropertyNames, i$5 = Object.getPrototypeOf, a$4 = Object.prototype.hasOwnProperty, o$4 = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), s$1 = (e, i, o, s) => {
	if (i && typeof i == `object` || typeof i == `function`) for (var c = r$6(i), l = 0, u = c.length, d; l < u; l++) d = c[l], !a$4.call(e, d) && d !== o && t$6(e, d, {
		get: ((e) => i[e]).bind(null, d),
		enumerable: !(s = n$7(i, d)) || s.enumerable
	});
	return e;
}, c$2 = (n, r, a) => (a = n == null ? {} : e$2(i$5(n)), s$1(r || !n || !n.__esModule ? t$6(a, `default`, {
	value: n,
	enumerable: !0
}) : a, n));
const e$1 = /^(?:( )+|\t+)/, t$5 = `space`;
...
function r$5(r, a) {
	...
	for (let u of r.split(/\n/g)) {
		...
		if (r === null) s = 0, c = ``;
			...
			let e = r[0].length, u = r[1] ? t$5 : `tab`;
			if (n$6(a, u, e)) continue;
			u !== c && (s = 0), c = u;
			let d = 1, f = 0, p = e - s;
			if (s = e, p === 0) d = 0, f = 1;
			else {
...
function c$1(e) {
	...
	t.size === 0 && (t = r$5(e, !1));
	let n = o$3(t), i, c = 0, l = ``;
	return n !== void 0 && ({type: i, amount: c} = a$3(n), l = s(i, c)), {
		amount: c,
		type: i,
		indent: l
	};
}
const t$4 = Symbol.for(`__confbox_fmt__`), n$5 = /^(\s+)/, r$4 = /(\s+)$/;
function i$3(e, t = {}) {
	return {
...
function a$2(e, n, r) {
	!n || typeof n != `object` || Object.defineProperty(n, t$4, {
		enumerable: !1,
		configurable: !0,
		writable: !0,
		value: i$3(e, r)
...
function o$2(n, r) {
	if (!n || typeof n != `object` || !(t$4 in n)) return {
		indent: r?.indent ?? 2,
		whitespace: {
			start: ``,
			end: ``
...
`;
	...
	function y() {
		...
		if (n$4(i)) return o++, s += String.fromCharCode(i), i === 13 && e.charCodeAt(o) === 10 && (o++, s += `
`), u++, f = o, l = 14;
		switch (i) {
			...
			case 47:
				...
				if (e.charCodeAt(o + 1) === 47) {
					for (o += 2; o < a && !n$4(e.charCodeAt(o));) o++;
				...
				if (e.charCodeAt(o + 1) === 42) {
					...
					for (; o < r;) {
						...
						o++, n$4(t) && (t === 13 && e.charCodeAt(o) === 10 && o++, u++, f = o);
					}
...
})(i$2 ||= {}), Array(20).fill(0).map((e, t) => ` `.repeat(t)), Array(200).fill(0).map((e, t) => `
...
function o$1(e, t = [], n = a$1.DEFAULT) {
	let r = null, i = [], o = [];
	function s(e) {
...
function d$1(t, n, r = a$1.DEFAULT) {
	let i = e(t, !1), o = [], s = 0;
	function c(e) {
...
var jsonc_exports = /* @__PURE__ */ __exportAll({ parseJSONC: () => r$2 });
function r$2(n, r) {
	let i = m$2(n, r?.errors, r);
	return a$2(n, i, r), i;
}
var t$1 = o$4(((e, t) => {
...
const I = globalThis.process?.platform || "", T = n$1(o.CI) || l.ci !== !1, R = n$1(globalThis.process?.stdout && globalThis.process?.stdout.isTTY), d = n$1(o.DEBUG), a = t === "test" || n$1(o.TEST);
n$1(o.MINIMAL);
const A = /^win/i.test(I);
/^linux/i.test(I);
/^darwin/i.test(I);
!n$1(o.NO_COLOR) && (n$1(o.FORCE_COLOR) || (R || A) && o.TERM);
const C = (globalThis.process?.versions?.node || "").replace(/^v/, "") || null;
Number(C?.split(".")[0]);
const W$1 = globalThis.process || Object.create(null), _ = { versions: {} };
new Proxy(W$1, { get(e, s) {
	if (s === "env") return o;
	if (s in e) return e[s];
	if (s in _) return _[s];
} });
const O = globalThis.process?.release?.name === "node", c = !!globalThis.Bun || !!globalThis.process?.versions?.bun, D = !!globalThis.Deno, L$1 = !!globalThis.fastly, S$1 = !!globalThis.Netlify, u = !!globalThis.EdgeRuntime, N$2 = globalThis.navigator?.userAgent === "Cloudflare-Workers", F = [
	[S$1, "netlify"],
	[u, "edge-light"],
	[N$2, "workerd"],
	[L$1, "fastly"],
...
async function detectImports(code, ctx, options) {
	if (options?.parser === "acorn") return import("../_libs/c12+rc9+rou3+nypm+klona+citty.mjs").then((n) => n.a).then((r) => r.detectImportsAcorn(code, ctx, options));
...
function getChunkName(chunk, nitro) {
	...
	if (chunk.moduleIds.every((id) => /node_modules[/\\]\w/.test(id))) {
		const pkgNames = [...new Set(chunk.moduleIds.map((id) => id.match(/.*[/\\]node_modules[/\\](?<package>@[^/\\]+[/\\][^/\\]+|[^/\\]+)/)?.groups?.package).filter(Boolean).map((name) => name.split(/[/\\]/).pop()).filter(Boolean))].sort((a, b) => a.length - b.length);
		let chunkName = "";
...
async function baseBuildPlugins(nitro, base) {
	...
	if (nitro.options.imports) {
		const unimportPlugin = await import("../_libs/c12+rc9+rou3+nypm+klona+citty.mjs").then((n) => n.i);
...
export { o$2 as $, compressPublicAssets as A, T as B, decode as C, prepare as D, parse as E, Builder as F, findFile$1 as G, d as H, prettyPath as I, readGitConfig as J, findNearestFile$1 as K, resolveNitroPath as L, build as M, glob as N, copyPublicAssets as O, require_picomatch as P, a$2 as Q, writeFile$1 as R, MagicString as S, Parser as T, p as U, a as V, dist_exports$1 as W, jsonc_exports as X, readPackageJSON$1 as Y, r$2 as Z, writeTypes as _, dataToEsm as a, dirname$2 as at, getMagicString as b, walk as c, join$2 as ct, libChunkName as d, resolve$3 as dt, c$2 as et, baseBuildConfig as f, writeDevBuildInfo as g, writeBuildInfo as h, createFilter as i, basename$2 as it, src_default as j, scanUnprefixedPublicAssets as k, NODE_MODULES_RE$1 as l, normalize$2 as lt, getBuildInfo as m, baseBuildPlugins as n, resolveModulePath as nt, extractAssignedNames as o, extname$4 as ot, runParallel as p, findWorkspaceDir as q, attachScopes as r, resolveModuleURL as rt, makeLegalIdentifier as s, isAbsolute$2 as st, oxc as t, o$4 as tt, getChunkName as u, relative$2 as ut, dist_exports as v, encode as w, stripLiteral as x, createUnimport as y, K$1 as z };
